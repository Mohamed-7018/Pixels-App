...
class EveryPixelIsAKnowledgeHeaderBox extends StatelessWidget {
  final Color color;

  EveryPixelIsAKnowledgeHeaderBox ({@required this.color});
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child : AnimatedText(
        ...
        wordList: ['Pixels', 'Every.', 'Pixel.', 'is Knowledge.'],
        textStyle: TextStyle(
          color: Colors.white,
          fontSize: 25,
